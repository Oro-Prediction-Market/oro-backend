...
export class AmlDetectorService {
   ...
   * Classic money-laundering pattern: cycle funds through the platform without gambling.
   */
   ...
   * Indicates funds passing through without genuine betting engagement.
   */
   ...
   * Consistent maximum utilisation suggests deliberate cycling behaviour.
   */
