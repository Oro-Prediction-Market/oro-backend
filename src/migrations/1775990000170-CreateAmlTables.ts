...
export class CreateAmlTables1775990000170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_aml_alerts_riskLevel"  ON "aml_alerts" ("riskLevel")`);
    await queryRunner.query(`CREATE INDEX "IDX_aml_alerts_isResolved" ON "aml_alerts" ("isResolved")`);
